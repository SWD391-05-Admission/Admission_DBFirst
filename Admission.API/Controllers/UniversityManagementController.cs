...
namespace Admission.API.Controllers
{
    ...
    public class UniversityManagementController : ControllerBase
    {
        ...
        public async Task<ActionResult> UpdateUniversity([FromBody] UpdateUniversity request)
        {
            ...
            {
                var universityCode = _iUniversityManagementService.GetUniversity(request.Code);
                if (universityCode != null) return StatusCode(400, (new { message = "University code already exists" }));
            }
